...
<?php $_title ="Edit Functional Annexes"; ?>
...
<?php endif; ?>
<?php if($this->session->userdata['role']['level'] == DISTRICT_ADMIN_LEVEL): ?>
<?php $_title ="Revise Functional Annexes"; ?>

<div id="topcontain">
    <div id="titlearea">
        <h1>Revise the Formatted Draft: Functional Annexes</h1>
...
<div class="col-half left">
    <p>Most of the work for the&nbsp;<a href="#" class="bt" title="The Functional Annexes section details the goals, objectives, and courses of action of functions (e.g., evacuation, lockdown, recovery) that apply across multiple threats or hazards. Functional annexes set forth how the school manages a function before, d">functional annexes</a>&nbsp;was completed in Step 3 and Step 4, when your team identified&nbsp;<a href="#" class="bt" title="Goals are broad, general statements that indicate the desired outcome in response to a threat or hazard.">goals</a> and<a href="#" class="bt" title="Objectives are specific, measurable actions that are necessary to achieve the goals.">&nbsp;objectives</a> for districtwide&nbsp;<a href="#" class="bt" title="Functions are activities that apply to more than one threat or hazard.">functions</a>. At this stage, you will help school core planning teams revise the formatted functional annexes according to writing conventions. This may include assisting with technical writing, contributing important information, and providing a list of points of contact for inclusion in the draft EOPs.</p>
<p>When developing policies and procedures, consider the extent to which you will provide assistance, training, guidance, feedback on early drafts, and districtwide plan content. Also consider how you will help school core planning teams connect with and acquire stakeholder feedback about the draft EOPs. Furthermore, consider the required accessible formats and languages in which the draft EOPs should be made available.</p>
</div>
...
<div class="col-half left">
	...
	<?php if($this->session->userdata['role']['level']==DISTRICT_ADMIN_LEVEL): ?>
	<table class="thform"><tr><td><p>To edit and format the content for each of your annexes, click on the corresponding Edit button. Revise the text as necessary in the designated fields and click the Update button to create a coherent Functional Annex.</p></td></tr></table>
	<p>&nbsp;</p>
	<?php endif; ?>
                    ...
                    <?php foreach($eligibleEntities as $key=>$value): ?>
                        ...
                        <tr>
                            <td colspan="2" style="display:none;">
                                <div title="Edit Functional Annexes" class="fieldsContainer" id="container-<?php echo $value['id'];?>"></div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
