...
<?php $_title ="Add/Edit Courses of Action for Threats and Hazards"; ?>
<div id="topcontain">
    <div id="titlearea">
...
<?php endif; ?>
<?php if($this->session->userdata['role']['level'] == DISTRICT_ADMIN_LEVEL): ?>
<?php $_title ="Develop Courses of Action for Threats and Hazards"; ?>
...
<div class="col-half left">
	...
	<?php if($this->session->userdata['role']['level']==DISTRICT_ADMIN_LEVEL): ?>
	<table class="thform"><tr><td>
		<p>To add school-specific courses of action, click Add for each threat or hazard below. In the space indicated, enter courses of action that accomplish the goals and objectives that your team or the school core planning team previously developed. After completing the courses of action fields for the selected threat or hazard, click Save. Repeat this process for the remaining threats and hazards.</p>
<p>To modify an existing course of action, click Edit for the chosen threat or hazard. Pre-populated fields will appear with previously saved information. After editing, click Update. Repeat this process as needed.</p>
		</td></tr></table>
	<p>&nbsp;</p>
	<?php endif; ?>
                    ...
                    <?php foreach($eligibleEntities as $key=>$value): ?>
                                        ...
                                        <?php if($mode=='add'): ?>
                                            <?php if(
                                                ...
                                                <?php if($value['copy']==YES): ?>
                                                    <a href="#" id="<?php echo $value['id'];?>" class="addThActionLink" data-mandate="<?=$value['mandate']?>">Add <img class="editIcon" src="<?php echo(base_url()); ?>assets/img/add_icon.png" alt="add icon"/></a>
                                                    <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                <?php if(
                                                    ...
                                                    <?php if($value['copy']==YES): ?>
                                                        <a href="#" id="<?php echo $value['id'];?>" class="editThActionLink" data-mandate="<?=$value['mandate']?>">Edit <img class="editIcon" src="<?php echo(base_url()); ?>assets/img/edit_icon.png" alt="edit icon"/></a>
                                                        <?php else: ?>
                                                            <a href="#" id="<?php echo $value['id'];?>" class="viewThActionLink" data-mandate="<?=$value['mandate']?>">View <img class="editIcon" src="<?php echo(base_url()); ?>assets/img/view_icon.png" alt="view icon"/></a>
                                                    <?php endif; ?>
                        ...
                        <tr>
                            <td colspan="3" style="display: none;">
                                <div class="fieldsContainer" title="Add/Edit Courses of Action for Threats and Hazards" id="container-<?php echo $value['id'];?>"></div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
